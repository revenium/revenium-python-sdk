...
class AICreateImageParams(TypedDict, total=False):
    ...
    source_image_provided: Annotated[bool, PropertyInfo(alias="sourceImageProvided")]
    """Whether the caller supplied a source image (edit and variation operations)"""

    source_transaction_id: Annotated[str, PropertyInfo(alias="sourceTransactionId")]
    """Transaction ID of the source image this operation derives from (edit-and-regenerate lineage)"""
    ...
    """The pricing tier this image operation is billed at"""

    priority_tier: Annotated[str, PropertyInfo(alias="priorityTier")]
    """The priority tier this image operation was queued at"""

    # Optional here, unlike the completion params: the image path has no
    # client-side invariant that a cost type is always supplied.
    cost_type: Annotated[Literal["AI"], PropertyInfo(alias="costType")]
    """Cost type for the image operation"""
