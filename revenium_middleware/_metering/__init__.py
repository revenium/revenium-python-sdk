...
# revenium_metering._exceptions.NotFoundError -> revenium_metering.NotFoundError
__locals = locals()
for __name in __all__:
    if not __name.startswith("__"):
        try:
            __locals[__name].__module__ = "revenium_middleware._metering"
